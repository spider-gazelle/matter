...
describe "Access Control Integration" do
  describe "commissioning workflow" do
    it "creates default ACL entry during commissioning" do
      ...
      acl_cluster = Matter::Cluster::AccessControlCluster.new(endpoint_id)
      ...
      default_acl = Matter::Cluster::AccessControlCluster::AccessControlEntry.new(
    ...
    it "enforces ACL for non-admin subjects" do
      ...
      # Create admin ACL
      admin_acl = Matter::Cluster::AccessControlCluster::AccessControlEntry.new(
        privilege: Matter::Cluster::AccessControlCluster::AccessControlEntryPrivilege::Administer,
        auth_mode: Matter::Cluster::AccessControlCluster::AccessControlEntryAuthMode::CASE,
        subjects: [admin_subject],
        targets: nil,
      ...
      viewer_acl = Matter::Cluster::AccessControlCluster::AccessControlEntry.new(
        privilege: Matter::Cluster::AccessControlCluster::AccessControlEntryPrivilege::View,
        auth_mode: Matter::Cluster::AccessControlCluster::AccessControlEntryAuthMode::CASE,
  ...
  describe "target-specific access control" do
    it "restricts access to specific clusters" do
      ...
      on_off_target = Matter::Cluster::AccessControlCluster::Target.new(
        cluster: 0x0006_u32,
        endpoint: nil,
        device_type: nil
      )
    ...
    it "restricts access to specific endpoints" do
      ...
      endpoint_target = Matter::Cluster::AccessControlCluster::Target.new(
        cluster: nil,
        endpoint: 1_u16,
        device_type: nil
      )
  ...
  describe "ACL attribute read/write via TLV" do
    it "allows admin to read and update ACL list" do
      ...
      # Create initial ACL
      initial_acl = Matter::Cluster::AccessControlCluster::AccessControlEntry.new(
        privilege: Matter::Cluster::AccessControlCluster::AccessControlEntryPrivilege::Administer,
        auth_mode: Matter::Cluster::AccessControlCluster::AccessControlEntryAuthMode::CASE,
        subjects: [admin_subject],
        targets: nil,
      ...
      encoded_acl.should be_a(Bytes)
      encoded_acl.as(Bytes).size.should be > 0
      ...
      new_acl_list = [
        initial_acl,
        Matter::Cluster::AccessControlCluster::AccessControlEntry.new(
          privilege: Matter::Cluster::AccessControlCluster::AccessControlEntryPrivilege::Operate,
          auth_mode: Matter::Cluster::AccessControlCluster::AccessControlEntryAuthMode::CASE,
      ...
      acl_cluster.acl.clear
      status = acl_cluster.write_attribute(Matter::Cluster::AccessControlCluster::ATTR_ACL, encoded_new_acl.as(Bytes))
    ...
    it "persists ACL across encode/decode cycles" do
      endpoint_id = Matter::DataType::EndpointNumber.new(0_u16)
      cluster1 = Matter::Cluster::AccessControlCluster.new(endpoint_id)

      # Create complex ACL with multiple entries and targets
      cluster1.acl << Matter::Cluster::AccessControlCluster::AccessControlEntry.new(
        privilege: Matter::Cluster::AccessControlCluster::AccessControlEntryPrivilege::Administer,
        auth_mode: Matter::Cluster::AccessControlCluster::AccessControlEntryAuthMode::CASE,
      ...
      # Encode
      encoded = cluster1.read_attribute(Matter::Cluster::AccessControlCluster::ATTR_ACL).as(Bytes)

      # Decode into new cluster
      cluster2 = Matter::Cluster::AccessControlCluster.new(endpoint_id)
      status = cluster2.write_attribute(Matter::Cluster::AccessControlCluster::ATTR_ACL, encoded)
      status.status.should eq(Matter::InteractionModel::StatusCode::Success)
