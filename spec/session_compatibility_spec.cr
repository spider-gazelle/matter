...
describe "Session Compatibility with matter.js" do
  describe "SecureMessage encryption/decryption" do
    it "decrypts message using matter.js test vectors" do
      ...
      _crypto = Matter::Crypto::StandardCrypto.new

      # Keys from matter.js
      encrypt_key = "66951379d0a6d151cf5472cccf13f360".hexbytes
      decrypt_key = "bacb178b2588443d5d5b1e4559e7accc".hexbytes

      # Encrypted message from matter.js (kept for reference)
      _encrypted_message = "001d350022145300ec2b931025dada82ed67521c966d2454d131a271023be699e4e2796650f568e590fd9b65f456c720a60a0da127eaa53974c5d41d3d933ed7b58a9ce5b5cb96ad94a7762611c48774cf75458327e74c34668a45dc9943546f8a6aa1dcd40bd4b8014befb49954a097a60cbdff333ee3f2fd1f49".hexbytes

      # Encrypted payload (application payload only, kept for reference)
      _encrypted_bytes = "".hexbytes

      # Expected decrypted payload (kept for reference)
      _decrypted_bytes = "153600172403312504fcff18172402002403302404001817240200240330240401181724020024033024040218172402002403302404031817240200240328240402181724020024032824040418172403312404031818290324ff0118".hexbytes
      ...
      # Build a minimal packet header for the AAD (kept for reference)
      # No source or destination node IDs, so flags is just version bits
      _flags = 0_u8
      _packet_header = Matter::Codec::MessageCodec::PacketHeader.new(
      ...
      _message_counter = 0_u32 # This would be extracted from the packet header
