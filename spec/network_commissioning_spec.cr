require "./spec_helper"
require "../src/matter/clusters/network_commissioning"

describe Matter::Clusters::NetworkCommissioning do
  describe "initialization" do
    it "creates cluster with default settings" do
      cluster = Matter::Clusters::NetworkCommissioning.new

      cluster.max_networks.should eq(4_u8)
    ...
    it "creates cluster with custom max networks" do
      cluster = Matter::Clusters::NetworkCommissioning.new(max_networks: 8_u8)
      cluster.max_networks.should eq(8_u8)
    end

    it "validates max_networks >= 1" do
      expect_raises(ArgumentError, "max_networks must be >= 1") do
        Matter::Clusters::NetworkCommissioning.new(max_networks: 0_u8)
      end
    end

    it "initializes WiFi-specific attributes when WiFi feature enabled" do
      cluster = Matter::Clusters::NetworkCommissioning.new(
        features: Matter::Clusters::NetworkCommissioning::Feature::WiFiNetworkInterface
      )

      cluster.supported_wifi_bands.should_not be_nil
      cluster.supported_wifi_bands.not_nil!.should contain(Matter::Clusters::NetworkCommissioning::WiFiBandEnum::Band2G4)
    end

    it "initializes Thread-specific attributes when Thread feature enabled" do
      cluster = Matter::Clusters::NetworkCommissioning.new(
        features: Matter::Clusters::NetworkCommissioning::Feature::ThreadNetworkInterface
      )
  ...
  describe "ScanNetworks command" do
    it "validates request parameters" do
      expect_raises(ArgumentError, "ssid must be 1-32 bytes") do
        Matter::Clusters::NetworkCommissioning::ScanNetworksRequest.new(ssid: Bytes.new(0))
      end

      expect_raises(ArgumentError, "ssid must be 1-32 bytes") do
        Matter::Clusters::NetworkCommissioning::ScanNetworksRequest.new(ssid: Bytes.new(33))
      end
    end

    it "requires armed failsafe" do
      cluster = Matter::Clusters::NetworkCommissioning.new
      cmd = Matter::Clusters::NetworkCommissioning::ScanNetworksRequest.new

      response = cluster.handle_scan_networks(cmd, failsafe_armed: false)
      response.networking_status.should eq(Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::UnknownError)
    end
    ...
    it "performs WiFi scan when WiFi feature enabled" do
      ...
      response.networking_status.should eq(Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::Success)
    ...
    it "performs directed WiFi scan with SSID filter" do
      ...
      cmd = Matter::Clusters::NetworkCommissioning::ScanNetworksRequest.new(ssid: ssid)
    ...
    it "updates state attributes after scan" do
      ...
      cluster.last_networking_status.should eq(Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::Success)
    end
  end
  ...
  describe "AddOrUpdateWiFiNetwork command" do
    it "validates request parameters" do
      expect_raises(ArgumentError, "ssid must be max 32 bytes") do
        Matter::Clusters::NetworkCommissioning::AddOrUpdateWiFiNetworkRequest.new(
          ssid: Bytes.new(33),
    ...
    it "requires armed failsafe" do
      cluster = Matter::Clusters::NetworkCommissioning.new
      cmd = Matter::Clusters::NetworkCommissioning::AddOrUpdateWiFiNetworkRequest.new(
        ssid: "TestSSID".to_slice,
    ...
    it "rejects empty SSID" do
      ...
      response = cluster.handle_add_or_update_wifi_network(cmd, failsafe_armed: true)
      response.networking_status.should eq(Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::OutOfRange)
    end
    ...
    it "updates existing WiFi network" do
      ...
      # Add network first
      cmd1 = Matter::Clusters::NetworkCommissioning::AddOrUpdateWiFiNetworkRequest.new(
        ssid: ssid,
      ...
      cmd2 = Matter::Clusters::NetworkCommissioning::AddOrUpdateWiFiNetworkRequest.new(
        ssid: ssid,
    ...
    it "rejects when max networks limit reached" do
      ...
      cmd3 = Matter::Clusters::NetworkCommissioning::AddOrUpdateWiFiNetworkRequest.new(
        ssid: "Network3".to_slice,
        credentials: "password".to_slice
      )
      response = cluster.handle_add_or_update_wifi_network(cmd3, failsafe_armed: true)

      response.networking_status.should eq(Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::BoundsExceeded)
    end
  ...
  describe "AddOrUpdateThreadNetwork command" do
    it "validates request parameters" do
      expect_raises(ArgumentError, "operational_dataset must be max 254 bytes") do
        Matter::Clusters::NetworkCommissioning::AddOrUpdateThreadNetworkRequest.new(
    ...
    it "requires armed failsafe" do
      cluster = Matter::Clusters::NetworkCommissioning.new
      cmd = Matter::Clusters::NetworkCommissioning::AddOrUpdateThreadNetworkRequest.new(
    ...
    it "updates existing Thread network" do
      ...
      # Add network first
      cmd1 = Matter::Clusters::NetworkCommissioning::AddOrUpdateThreadNetworkRequest.new(
        operational_dataset: dataset
      )
      cluster.handle_add_or_update_thread_network(cmd1, failsafe_armed: true)

      # Update with same XPAN ID (first 8 bytes)
      cmd2 = Matter::Clusters::NetworkCommissioning::AddOrUpdateThreadNetworkRequest.new(
        operational_dataset: dataset
      )
  ...
  describe "RemoveNetwork command" do
    it "validates request parameters" do
      expect_raises(ArgumentError, "network_id must be 1-32 bytes") do
        Matter::Clusters::NetworkCommissioning::RemoveNetworkRequest.new(
    ...
    it "requires armed failsafe" do
      cluster = Matter::Clusters::NetworkCommissioning.new
      cmd = Matter::Clusters::NetworkCommissioning::RemoveNetworkRequest.new(
    ...
    it "returns NetworkIdNotFound for non-existent network" do
      ...
      response.networking_status.should eq(Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::NetworkIdNotFound)
    end
    ...
    it "removes network successfully" do
      ...
      # Add network first
      add_cmd = Matter::Clusters::NetworkCommissioning::AddOrUpdateWiFiNetworkRequest.new(
        ssid: ssid,
        credentials: "password".to_slice
      )
      ...
      # Remove network
      remove_cmd = Matter::Clusters::NetworkCommissioning::RemoveNetworkRequest.new(
        network_id: ssid
      )
  ...
  describe "ConnectNetwork command" do
    it "validates request parameters" do
      expect_raises(ArgumentError, "network_id must be 1-32 bytes") do
        Matter::Clusters::NetworkCommissioning::ConnectNetworkRequest.new(
          network_id: Bytes.new(0)
        )
      end
    end
    ...
    it "requires armed failsafe" do
      cluster = Matter::Clusters::NetworkCommissioning.new
      cmd = Matter::Clusters::NetworkCommissioning::ConnectNetworkRequest.new(
        network_id: "test".to_slice
      )
    ...
    it "connects to network successfully" do
      ...
      # Connect to network
      connect_cmd = Matter::Clusters::NetworkCommissioning::ConnectNetworkRequest.new(
        network_id: ssid
      )
  ...
  describe "ReorderNetwork command" do
    it "validates request parameters" do
      expect_raises(ArgumentError, "network_id must be 1-32 bytes") do
        Matter::Clusters::NetworkCommissioning::ReorderNetworkRequest.new(
          network_id: Bytes.new(0),
          network_index: 0_u8
        )
      end
    ...
    it "requires armed failsafe" do
      cluster = Matter::Clusters::NetworkCommissioning.new
      cmd = Matter::Clusters::NetworkCommissioning::ReorderNetworkRequest.new(
        network_id: "test".to_slice,
        network_index: 0_u8
      )
    ...
    it "returns OutOfRange for invalid network_index" do
      ...
      reorder_cmd = Matter::Clusters::NetworkCommissioning::ReorderNetworkRequest.new(
  ...
  describe "data structure validations" do
    it "validates NetworkInfo network_id length" do
      expect_raises(ArgumentError, "network_id must be 1-32 bytes") do
        Matter::Clusters::NetworkCommissioning::NetworkInfo.new(
          network_id: Bytes.new(0),
          connected: false
        )
      end
    ...
    it "validates WiFiInterfaceScanResult ssid and bssid lengths" do
      expect_raises(ArgumentError, "ssid must be max 32 bytes") do
        Matter::Clusters::NetworkCommissioning::WiFiInterfaceScanResult.new(
          ssid: Bytes.new(33)
        )
      end
    ...
    it "validates ThreadInterfaceScanResult network_name and pan_id" do
      expect_raises(ArgumentError, "network_name must be 1-16 chars") do
        Matter::Clusters::NetworkCommissioning::ThreadInterfaceScanResult.new(
          network_name: ""
        )
      end
    ...
    it "validates response debug_text length" do
      expect_raises(ArgumentError, "debug_text must be max 512 chars") do
        Matter::Clusters::NetworkCommissioning::ScanNetworksResponse.new(
          networking_status: Matter::Clusters::NetworkCommissioning::NetworkCommissioningStatus::Success,
          debug_text: "A" * 513
        )
      end
    end
