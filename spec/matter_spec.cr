...
describe Matter do
  ...
  it "encodes/decodes packet and payload header into a message" do
    ...
    payload_encoded_packet = codec.encode(message)
    second_message = codec.decode(payload_encoded_packet)
  ...
  it "encodes/decodes dns messages" do
    ...
    encoded_message = codec.encode_message(Matter::Codec::DNSCodec::MessageType::Query, 2_u16, queries: queries, answers: answers)
