  ...
  module Cluster
    ...
    class GroupsCluster < Base
      ...
      protected def encode_generated_command_list_global : Bytes
        ...
        writer.put_unsigned_int(nil, CMD_ADD_GROUP_RESPONSE, force_size: 4)
        writer.put_unsigned_int(nil, CMD_VIEW_GROUP_RESPONSE, force_size: 4)
        writer.put_unsigned_int(nil, CMD_GET_GROUP_MEMBERSHIP_RESPONSE, force_size: 4)
        writer.put_unsigned_int(nil, CMD_REMOVE_GROUP_RESPONSE, force_size: 4)
