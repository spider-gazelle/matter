  ...
  module Cluster
    ...
    class GroupsCluster < Base
      ...
      protected def encode_cluster_revision_global : Bytes
        encode_uint16(4_u16) # Groups cluster revision 4
      end
      ...
      protected def encode_generated_command_list_global : Bytes
        # Response commands generated by this cluster (fixed_size: true per Matter spec)
        items = [
          TLV::Any.new(CMD_ADD_GROUP_RESPONSE, nil, fixed_size: true),
          TLV::Any.new(CMD_VIEW_GROUP_RESPONSE, nil, fixed_size: true),
          TLV::Any.new(CMD_GET_GROUP_MEMBERSHIP_RESPONSE, nil, fixed_size: true),
          TLV::Any.new(CMD_REMOVE_GROUP_RESPONSE, nil, fixed_size: true),
        ]
