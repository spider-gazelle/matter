module Matter
  module Storage
    abstract class Base
      ...
      abstract def get(contexts : Array(String), key : String) : LegacyType
      abstract def set(contexts : Array(String), key : String, value : LegacyType) : Nil
      abstract def delete(contexts : Array(String), key : String) : Nil
      abstract def keys(contexts : Array(String)) : Array(String)
      abstract def values(contexts : Array(String)) : Hash(String, LegacyType)
